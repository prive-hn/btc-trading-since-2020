...
BitMEX 在其 11 周年 `Hall of Legends` 页面中，将 Paul Wei（`@coolish`）列为官方传奇交易员之一，并公开强调其“三年内仅比特币交易收益达 70 倍”（[来源](https://www.bitmex.com/zh-hans/hall-of-legends)）。但这个仓库更深一层的价值，不在于某一个 headline 数字，而在于它把一个长期 BTC 交易过程做成了可公开检查、带时间戳、跨越多个市场周期的完整档案。这里面不只有高光，也包括反转、回撤、恢复，以及在不确定性下不断修正判断的全过程。
